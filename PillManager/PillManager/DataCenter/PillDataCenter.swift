...
struct PillDataCenter {
    ...
    var savePill: (HistoryDataCenter, _ completion: ((Error?) -> Void)?) -> Void
    var fetchPillDate: (_ completion: ((Result<Date?, Error>) -> Void)?) -> Void
    var fetchPillDateLocal: () -> Date?
    var deletePill: (HistoryDataCenter, _ completion: ((Error?) -> Void)?) -> Void
...
extension PillDataCenter {
    ...
    static let live: PillDataCenter = .init { historyDataCenter, completion in
        ...
        historyDataCenter.saveDefaultHistory(Date(), nil)
    ...
    } deletePill: { historyDataCenter, completion in
        ...
        historyDataCenter.removeDefaultHistory(Date(), nil)
